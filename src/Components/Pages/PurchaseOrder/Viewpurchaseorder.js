...
const DataTable = () => {
    ...
    useEffect(() => {
        const getData = () => {
            ...
            fetch("http://localhost:3009/getPOData")
                                ...
                                <tbody>
                                    {commentsData.map(comment => (
                                        <tr>
                                            ...
                                            <td onClick={() => openInPopup(comment.PO_ID)}>{comment.PO_ID}</td>
                                            <td onClick={() => openInPopup(comment.PO_ID)}>{comment.DOC_NO}</td>
                                    ...
                                    {/* <tr>
                                        ...
                                        <td onClick={() => openInPopup()}>POID</td>
